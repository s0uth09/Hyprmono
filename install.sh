...
#    config/hypr/hyprland/          ← modules
#    config/hypr/hyprlock/          ← hyprlock + hypridle
...
#    config/fuzzel/                 ← launcher (alt)
#    config/fontconfig/             ← font rules
#    config/xdg-desktop-portal/     ← portal config
